...
<html lang="nl">
    ...
    <?php include './includes/header.php';?>
        ...
        <div class="sub_menu">
            <div class="wrapper">
                ...
                <a href="<?php echo $privacy_beleid; ?>">Privacy Beleid</a>
            </div>
        </div>    
    </header>
    <!-- /HEADER AREA -->
    ...
    <main class="pr_bel">
        <div class="wrapper">
            <h1>Privacy Beleid StagePeer</h1>
            ...
            <p>Dit privacybeleid is van toepassing op de diensten van StagePeer. U dient zich ervan bewust te zijn dat StagePeer niet verantwoordelijk is voor het privacybeleid van andere sites en bronnen. Door gebruik te maken van deze website geeft u aan het privacy beleid te accepteren.</p>
            <p>StagePeer respecteert de privacy van alle gebruikers van haar site en draagt er zorg voor dat de persoonlijke informatie die u ons verschaft vertrouwelijk wordt behandeld.</p>
            
            <h2>Ons gebruik van verzamelde gegevens</h2>
            <h3>Gebruik van onze diensten</h3>
            <p>Wanneer u zich aanmeldt voor een van onze diensten vragen we u om persoonsgegevens te verstrekken. Deze gegevens worden gebruikt om de dienst uit te kunnen voeren. De gegevens worden opgeslagen op eigen beveiligde servers van StagePeer of die van een derde partij. Wij zullen deze gegevens niet combineren met andere persoonlijke gegevens waarover wij beschikken.</p>
            
            <h3>Communicatie</h3>
            <p>Wanneer u e-mail of andere berichten naar ons verzendt, is het mogelijk dat we die berichten bewaren. Soms vragen wij u naar uw persoonlijke gegevens die voor de desbetreffende situatie relevant zijn. Dit maakt het mogelijk uw vragen te verwerken en uw verzoeken te beantwoorden. De gegevens worden opgeslagen op eigen beveiligde servers van StagePeer of die van een derde partij. Wij zullen deze gegevens niet combineren met andere persoonlijke gegevens waarover wij beschikken.</p>
