    ...
    <div class="wrapper beheer">  
        ...
        <main>
           <h1>Vacature toevoegen</h1>
            ...
            <?php 
            if (!$geverificeerd) {
                echo '<div class="info" style="font-weight: 700; border: 1px solid lightgray; padding: 5px 0 5px 5px; font-size:16px;">U bent nog niet geverificeerd en kunt daarom geen nieuwe vacatures toevoegen.</div>';
            }
